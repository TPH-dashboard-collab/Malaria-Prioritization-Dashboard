...
ui <- dashboardPage(
  ...
  dashboardHeader(title = "Tanzania Malaria Intervention Prioritization"),
  ...
  dashboardSidebar(
    ...
    tags$div(
      ...
      HTML("<strong>Metric:</strong> nUncompCum (cumulative to 2030)<br>
    ...
    tabItems(
      ...
      tabItem(tabName = "home",
               ...
               counterfactual analysis."),
                  ...
                  tags$ol(
                    tags$li(strong("Data Preparation:"),
                            " Filter EIR_mean, calculate cumulative nUncomp by year"),
              ...
              fluidRow(
                ...
                valueBox("Counterfactual", "Method Used",
